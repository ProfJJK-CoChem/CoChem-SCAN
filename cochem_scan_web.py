...
st.set_page_config(page_title="CoChem-SCAN - Novice Web UI", layout="wide")

st.title("🔬 CoChem-SCAN Control Panel")
...
if st.button("🚀 Execute Default Pipeline"):
    with st.spinner(f"Initializing CoChem-SCAN payload for {target_smiles}..."):
        time.sleep(1)
